...
```{r}
data <- read.csv("/home/jiwang/projects/gh_jiwang/EIO_shelf_life_stability_study/accelerated_shelf_life/EIO_accelerated_stability_sample_information.csv") %>% 
...
data_select$Time_point <- factor(data_select$Time_point, levels = c("T00", "Td4", "Td6", "Td8", "Td10"))
...
ggplot(data_select, aes(Time_point, y = LPC_quant)) +
  ...
  labs(title = "LPC Quant By Accelerated Stability Study Timepoint-VCv2", colour  = "Time_point") +
...
Plot scatter for LPC quant by timepoint for VC and NTC 
```{r, fig.width=20, fig.height=9, message=FALSE}
...
data_select1$Time_point <- factor(data_select1$Time_point, levels = c("T00", "Td4", "Td6", "Td8", "Td10"))
unique(data_select1$Time_point)

ggplot(data_select1, aes(Time_point, y = LPC_quant)) +
  geom_point(aes(colour =  Sample_type)) +
  scale_color_manual(values = c("red", "blue")) +
  labs(title = "LPC Quant By Accelerated Stability Study Timepoint-VC and NTC", colour  = "Sample Type") +
  ylab("LPC Quant (ng/ul)") +
  xlab("Time_point") +
  theme_Publication() +
theme(legend.position = 'right',
...
ggplot(data_select, aes(Time_point, y = EN_quant)) +
  ...
  labs(title = "EN Quant By Accelerated Stability Study Timepoint-VCv2", colour  = "Time_point") +
  ylab("EN Quant (nM)") +
  xlab("Time_point") +
  theme_Publication() +
 theme(legend.position = 'right',
...
Plot scattor for ENC quant by timepoint for VC and NTC 
```{r, fig.width=20, fig.height=9, message=FALSE}
...
ggplot(data_select1, aes(Time_point, y = EN_quant)) +
  ...
  scale_color_manual(values = c("red", "blue")) +
  geom_hline( yintercept = 0.35, lty = "dashed", color = "red") +
  labs(title = "EN Quant By Accelerated Stability Study Timepoint-VC and NTC", colour  = "Sample Type") +
  ylab("EN Quant (nM)") +
  xlab("Time_point") +
  theme_Publication() +
theme(legend.position = 'right',
