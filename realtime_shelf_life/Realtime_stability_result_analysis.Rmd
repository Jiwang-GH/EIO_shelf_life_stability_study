...
data_select$Time_point <- factor(data_select$Time_point, levels = c("T00", "T04",  "T08", "T12", "T16", "T21"))
...
```{r, fig.width=12, fig.height=9, message=FALSE}
data_select1 <-  data %>% 
  filter((Sample_type != "VCv2") & (!(Time_point == "T21" & Position == 'H:2')) ) 
...
data_select1$Time_point <- factor(data_select1$Time_point, levels = c("T00", "T04", "T08", "T12", "T16", "T21"))
